...
class Scores:
    def __init__(self, dbfile='data.db', table="users", columns=('id', 'reputation')):
    ...
    def init_table(self):
        self.conn.execute('''CREATE TABLE IF NOT EXISTS users (id integer PRIMARY KEY,reputation integer);''')
